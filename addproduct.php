...
<hr>
<div id="ac">
<span>Bar code : </span><input type="text" style="width:265px; height:30px;" name="code" ><br>
<span>Brand Name : </span><input type="text" style="width:265px; height:30px;" name="gen" Required/><br>
